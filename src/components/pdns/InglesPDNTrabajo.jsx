...
export const InglesPDNTrabajo = ({pdnSelect, setPdnSelect}) => {
        ...
        <main className='main-content'>
            {
                pdnSelect.trabajoi_id != 0 ? (
                    ...
                    <h1 className='main-content__title'>
                        ...
                        {" "}/{" "}
                        <span className='cursor-pointer' onClick={() => navigate(`/ingles/${pdnSelect.cursoi_url}`)}>{pdnSelect.cursoi_nombre}</span>
                        {" "}/ {pdnSelect.trabajoi_nombre}
                    </h1>
                    {
                        solicitudAceptada ? (
                            ...
                            <section className='bg-white-shadow pd-3'>
                                <header className='trabajo-ayuda-detalle__header'>
                                    <h1>{pdnSelect.trabajoi_nombre}</h1>
                                    <p className={
